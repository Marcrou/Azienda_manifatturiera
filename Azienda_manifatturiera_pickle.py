...
Dipartimento1.salva() #Salva i dati inseriti

"""

Dipartimento_Sfere = Dipartimento("Dipartimento1")  #Carica i dati inseriti

Dipartimento_Sfere.leggi()

Dipartimento_Sfere.stampa_dipartimento()
